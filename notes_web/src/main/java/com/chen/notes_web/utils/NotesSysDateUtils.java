package com.chen.notes_web.utils;
/**
 * 时间操作工具类
 * @author MaybeBin
 * @since 2022-02-17 10:45
 */
...
public class NotesSysDateUtils {
    ...
    public static Logger log = LoggerFactory.getLogger(NotesSysDateUtils.class);
